...
/***/ "../node_modules/@firestitch/filter/filter.umd.js":
/***/ (function(module, exports, __webpack_require__) {

(function (global, factory) {
	 true ? factory(exports, __webpack_require__("@angular/common"), __webpack_require__("@angular/forms"), __webpack_require__("@angular/core"), __webpack_require__("@angular/material"), __webpack_require__("../node_modules/@firestitch/datepicker/index.js"), __webpack_require__("../node_modules/@firestitch/common/common.umd.js"), __webpack_require__("../node_modules/@firestitch/store/store.umd.js"), __webpack_require__("rxjs/Observable"), __webpack_require__("@angular/router"), __webpack_require__("rxjs/add/observable/forkJoin"), __webpack_require__("../node_modules/moment-timezone/index.js"), __webpack_require__("@angular/flex-layout")) :
	typeof define === 'function' && define.amd ? define(['exports', '@angular/common', '@angular/forms', '@angular/core', '@angular/material', '@firestitch/datepicker', '@firestitch/common', '@firestitch/store', 'rxjs/Observable', '@angular/router', 'rxjs/add/observable/forkJoin', 'moment-timezone', '@angular/flex-layout'], factory) :
	(factory((global.filter = {}),global.common,global.forms,global.core,global.material,global.datepicker,global.common$1,global.store,global.Observable,global.router,null,global.moment,global.flexLayout));
}(this, (function (exports,common,forms,core,material,datepicker,common$1,store,Observable,router,forkJoin,moment,flexLayout) { 'use strict';
...
var FsFilterComponent = (function () {
    function FsFilterComponent(FsUtil$$1, FsArray$$1, FsStore$$1, router$$1, route) {
        this.FsUtil = FsUtil$$1;
        this.FsArray = FsArray$$1;
        this.FsStore = FsStore$$1;
     ...
     * @return {?}
     */
    FsFilterComponent.prototype.ngOnInit = /**
     * @return {?}
     */
    function () {
        var _this = this;
        ...
        if (this.filter.fsConfig.persist) {
            ...
            if (this.filter.fsConfig.persist.timeout) {
                var /** @type {?} */ date = new Date(this.persists[this.filter.fsConfig.persist.name]['date']);
        ...
        var /** @type {?} */ wait_observables$ = [], /** @type {?} */ update_observables$ = [];
        for (var _i = 0, _a = this.filter.fsConfig.items; _i < _a.length; _i++) {
            ...
            if (this.filter.fsConfig.persist) {
                var /** @type {?} */ persisted = this.persists[this.filter.fsConfig.persist.name]['data'];
                if (persisted[filter.name]) {
                    var /** @type {?} */ value = persisted[filter.name];
                    if (value) {
            ...
            if (filter.query) {
                var /** @type {?} */ query = this.route.snapshot.queryParams[filter.query];
                if (query !== undefined) {
                    query += '';
                    filter.model = query;
                    if (!query.length) {
                        ...
                        var /** @type {?} */ parts = filter.model.split(',');
            ...
            var /** @type {?} */ observable$ = this.sanitizeFilter(filter);
        ...
        Observable.Observable.forkJoin(wait_observables$)
            .subscribe(function () { }, function () { }, function () {
            if (_this.filter.fsConfig.load) {
                _this.reload({ filterUpdate: false });
            }
            Observable.Observable.forkJoin(update_observables$)
                .subscribe(function () { }, function () { }, function () {
     ...
     * @return {?}
     */
    FsFilterComponent.prototype.menuFilterChange = /**
     * @param {?} search
     * @return {?}
     */
    function (search) {
        ...
        for (var /** @type {?} */ label in values) {
            if (!values[label]) {
                continue;
            }
            var /** @type {?} */ filter = this.FsArray.filter(this.filter.fsConfig.items, { label: label })[0];
            if (filter) {
                if (filter.type == 'date' || filter.type == 'datetime') {
                    var /** @type {?} */ date = Date.parse(values[label]);
                    if (date) {
                        filter.model = moment(date);
                    }
                }
                else if (filter.type == 'daterange') {
                    var /** @type {?} */ parts = values[label].split(/\s+to\s+/);
                    var /** @type {?} */ from = Date.parse(parts[0]);
                    var /** @type {?} */ to = Date.parse(parts[1]);
                    filter.model = {};
                    if (from) {
                    ...
                    var /** @type {?} */ parts = values[label].split(',');
                    filter.model = { min: parts[0], max: parts[1] };
                }
                    ...
                    if (filter.multiple) {
                        ...
                        for (var _e = 0, _f = values_1[label].split(','); _e < _f.length; _e++) {
                            var value = _f[_e];
                            var /** @type {?} */ item = this.FsArray.filter(filter.values, { name: value })[0];
                            if (item) {
                        ...
                        var /** @type {?} */ item = this.FsArray.filter(filter.values, { name: values[label] })[0];
                        if (item) {
     ...
     * @return {?}
     */
    FsFilterComponent.prototype.filtersClear = /**
     * @return {?}
     */
    function () {
        for (var _i = 0, _a = this.filter.fsConfig.items; _i < _a.length; _i++) {
     ...
     * @return {?}
     */
    FsFilterComponent.prototype.menuFilterClick = /**
     * @param {?} $event
     * @return {?}
     */
    function ($event) {
        if (window.innerWidth >= 600) {
            ...
            if (window.getSelection && window.getSelection().toString()) {
                var /** @type {?} */ selected_1 = window.getSelection().toString();
                if (selected_1) {
                    setTimeout(function () {
                        var /** @type {?} */ index = $event.target.value.indexOf(selected_1);
                        if (index >= 0) {
     ...
     * @return {?}
     */
    FsFilterComponent.prototype.menuFilterKeydown = /**
     * @param {?} $event
     * @return {?}
     */
    function ($event) {
     ...
     * @return {?}
     */
    FsFilterComponent.prototype.menuFilterShow = /**
     * @return {?}
     */
    function () {
     ...
     * @return {?}
     */
    FsFilterComponent.prototype.clear = /**
     * @return {?}
     */
    function () {
        this.filtersClear();
     ...
     * @return {?}
     */
    FsFilterComponent.prototype.reload = /**
     * @param {?=} opts
     * @return {?}
     */
    function (opts) {
     ...
     * @return {?}
     */
    FsFilterComponent.prototype.load = /**
     * @param {?=} opts
     * @return {?}
     */
    function (opts) {
        ...
        var /** @type {?} */ query = this.gets({ flatten: true });
        if (this.filter.fsConfig.persist) {
     ...
     * @return {?}
     */
    FsFilterComponent.prototype.filterToggle = /**
     * @param {?} value
     * @param {?=} search
     * @return {?}
     */
     ...
     * @return {?}
     */
    FsFilterComponent.prototype.onFilterChange = /**
     * @param {?} filter
     * @param {?=} $event
     * @return {?}
     */
     ...
     * @return {?}
     */
    FsFilterComponent.prototype.onAutocompleteChange = /**
     * @param {?} filter
     * @param {?=} $event
     * @return {?}
     */
     ...
     * @return {?}
     */
    FsFilterComponent.prototype.onAutocompleteChipsChange = /**
     * @param {?} filter
     * @param {?} input
     * @return {?}
     */
    function (filter, input) {
        ...
        if (!this.FsUtil.isObject(filter.selectedValue)) {
            filter.values$ = filter.values(filter.selectedValue)
                .map(function (values) {
                var /** @type {?} */ selected = _this.FsArray.list(filter.model, 'value');
                return _this.FsArray.filter(values, function (value) {
                    return (/** @type {?} */ (selected)).indexOf(value.value) === -1;
                });
            });
        }
        else {
     ...
     * @return {?}
     */
    FsFilterComponent.prototype.removeAutucompleteChipItem = /**
     * @param {?} filter
     * @param {?} item
     * @return {?}
     */
     ...
     * @return {?}
     */
    FsFilterComponent.prototype.addAutucompleteChipItem = /**
     * @param {?} filter
     * @param {?} $event
     * @return {?}
     */
     ...
     * @return {?}
     */
    FsFilterComponent.prototype.filterKeyup = /**
     * @param {?} filter
     * @param {?} $event
     * @return {?}
     */
     ...
     * @return {?}
     */
    FsFilterComponent.prototype.filterUpdate = /**
     * @return {?}
     */
    function () {
        var /** @type {?} */ label, /** @type {?} */ formatted, /** @type {?} */ searches = [];
        for (var _i = 0, _a = this.filter.fsConfig.items; _i < _a.length; _i++) {
            var filter = _a[_i];
            var /** @type {?} */ value = this.copy(filter.model);
            ...
            if (filter.type == 'autocomplete') {
                ...
                if (value) {
                    var /** @type {?} */ from = moment(value.from);
                    var /** @type {?} */ to = moment(value.to);
                    var /** @type {?} */ format = filter.type == 'datetimerange' ? 'MMM D, YYYY h:mm a' : 'MMM D, YYYY';
                    value = [];
                    if (from) {
                ...
                var /** @type {?} */ min = value['min'];
                var /** @type {?} */ max = value['max'];
                var /** @type {?} */ parts = [];
                if (min) {
                    parts.push(min);
                }
     ...
     * @return {?}
     */
    FsFilterComponent.prototype.sanitizeFilter = /**
     * @param {?} filter
     * @return {?}
     */
    function (filter) {
        ...
        var /** @type {?} */ observable$ = new Observable.Observable(function (observer) {
            if (filter.values && typeof filter.values == 'object' && filter.values instanceof Observable.Observable) {
        ...
        var /** @type {?} */ $subscriber = observable$.subscribe(function (values) {
            if (filter.primary) {
                _this.primary = true;
            }
            else {
            ...
            if (filter.type == 'checkbox') {
                ...
                filter.values = data;
                if (filter.isolate) {
                    for (var /** @type {?} */ index in filter.values) {
     ...
     * @return {?}
     */
    FsFilterComponent.prototype.walkSelectValues = /**
     * @param {?} filter
     * @param {?} filterValues
     * @return {?}
     */
    function (filter, filterValues) {
        var /** @type {?} */ values = [];
        for (var /** @type {?} */ key in filterValues) {
            if (!filterValues[key]) {
                continue;
            }
            var /** @type {?} */ value = { value: key, name: filterValues[key] };
     ...
     * @return {?}
     */
    FsFilterComponent.prototype.walkSelectNestedValues = /**
     * @param {?} filter
     * @param {?} parent_id
     * @param {?} values
     * @param {?=} depth
     * @return {?}
     */
    function (filter, parent_id, values, depth) {
        if (depth === void 0) { depth = 0; }
        var /** @type {?} */ prepped_values = [];
        var /** @type {?} */ value_field = filter.nested.value_field || 'id';
        var /** @type {?} */ parent_field = filter.nested.parent_field || 'parent_id';
        var /** @type {?} */ name_field = filter.nested.label_field || 'name';
        for (var /** @type {?} */ key in values) {
            ...
            var /** @type {?} */ children = this.walkSelectNestedValues(filter, values[key][value_field], values, depth + 1);
     ...
     * @return {?}
     */
    FsFilterComponent.prototype.selectChange = /**
     * @param {?} filter
     * @return {?}
     */
    function (filter) {
        if (filter.isolate) {
            ...
            if (filter.multiple && this.FsUtil.isArray(filter.model)) {
                var /** @type {?} */ index = filter.model.indexOf(filter.isolate.value);
                if (index > -1) {
     ...
     * @return {?}
     */
    FsFilterComponent.prototype.isolateChange = /**
     * @param {?} filter
     * @return {?}
     */
    function (filter) {
     ...
     * @return {?}
     */
    FsFilterComponent.prototype.reset = /**
     * @return {?}
     */
    function () {
        this.clear();
     ...
     * @return {?}
     */
    FsFilterComponent.prototype.displayAutocomplete = /**
     * @param {?} data
     * @return {?}
     */
    function (data) {
     ...
     * @return {?}
     */
    FsFilterComponent.prototype.gets = /**
     * @param {?=} opts
     * @return {?}
     */
    function (opts) {
        ...
        for (var _i = 0, _a = this.filter.fsConfig.items; _i < _a.length; _i++) {
            ...
            if (filter.type == 'date' || filter.type == 'datetime') {
                ...
                var /** @type {?} */ from = value['from'];
                var /** @type {?} */ to = value['to'];
                value = {};
                if (from) {
            ...
            if (this.FsUtil.isObject(filter.names) && opts['names'] !== false) {
                for (var /** @type {?} */ key in filter.names) {
     ...
     * @return {?}
     */
    FsFilterComponent.prototype.copy = /**
     * \@TODO Temp solution
     * @param {?} data
     * @return {?}
     */
     ...
     * @return {?}
     */
    FsFilterComponent.prototype.ngOnDestroy = /**
     * @return {?}
     */
    function () { };
    FsFilterComponent.decorators = [
        { type: core.Component, args: [{
                    selector: 'fs-filter',
                    template: "<div class=\"fs-filter\" fxLayout=\"row\" fxLayoutAlign=\"start stretch\" *ngIf=\"filter.fsConfig.items.length\" [ngClass]=\"{ 'filters-open': extended_filter, loading: loading }\"> <div *ngIf=\"!filter.fsConfig.inline\" fxLayou=\"row\" fxLayoutAlign=\"start center\" class=\"menu-filter\" fxFlex> <div class=\"menu-filter-input\" fxFlex=\"grow\"> <div class=\"main-filter-bar\" fxLayout=\"row\" fxLayoutAlign=\"start center\" *ngIf=\"filter.fsConfig.items.length\"> <mat-form-field> <input matInput [(ngModel)]=\"searchinput.value\" name=\"filter-input\" (ngModelChange)=\"menuFilterChange(searchinput.value)\" (click)=\"menuFilterClick($event)\" (keydown)=\"menuFilterKeydown($event)\"> <mat-placeholder><mat-icon>search</mat-icon> Search</mat-placeholder> </mat-form-field> <div class=\"inline-actions\" fxLayout=\"row\" fxLayoutAlign=\"start center\"> <a (click)=\"menuFilterShow()\" class=\"action-filter\" [fxHide.gt-xs]=\"true\"><mat-icon>filter_list</mat-icon></a> <a (click)=\"clear()\" *ngIf=\"searchinput.value\"><mat-icon>clear</mat-icon></a> <a (click)=\"reload()\" class=\"action-reload\"><mat-icon>refresh</mat-icon></a> </div> </div> <div class=\"filters\"> <div class=\"wrap\"> <!-- @TODO Mobal version of filters fs-heading heading-actions --> <div class=\"filter-by\" fxLayout=\"row\" [fxHide.gt-xs]=\"true\"> <!-- fs-heading --> <span>Filter by</span> <div fxFlex></div> <div><!-- heading-actions --> <a (click)=\"filterToggle(false,true)\"><mat-icon class=\"action-clear\">clear</mat-icon></a> </div> </div> <ng-container *ngFor=\"let filterItem of filter.fsConfig.items\"> <ng-container *ngTemplateOutlet=\"filterTemplate; context: { localSk: filterItem }\"></ng-container> </ng-container> <div class=\"buttons\"> <button mat-raised-button color=\"accent\" (click)=\"filterToggle(false,true)\" class=\"filter-button\">Search</button> <button mat-button color=\"accent\" (click)=\"reset()\" class=\"reset-button\">Reset</button> </div> </div> </div> <div class=\"backdrop\" *ngIf=\"extended_filter\" (click)=\"filterToggle(false,true)\"></div> </div> </div> <div *ngIf=\"filter.fsConfig.inline\" class=\"inline-filter\"> <ng-container *ngFor=\"let filterItem of filter.fsConfig.items\"> <ng-container *ngTemplateOutlet=\"filterTemplate; context: { localSk: filterItem }\"></ng-container> </ng-container> </div> </div> <ng-template #filterTemplate let-filterItem=\"localSk\"> <div class=\"filter-group\" *ngIf=\"!filterItem.disabled\"> <div class=\"filter filter-{{ filterItem.type }}\"> <div class=\"filter-label\" *ngIf=\"!filter.fsConfig.inline\"> <div class=\"filter-label-content\"> {{ filterItem.label }} </div> </div> <div class=\"interface\" *ngIf=\"filterItem.type == 'text'\"> <mat-form-field> <input matInput [(ngModel)]=\"filterItem.model\" (keyup)=\"filterKeyup(filterItem,$event)\" (change)=\"onFilterChange(filterItem, $event)\"/> <mat-placeholder *ngIf=\"filter.fsConfig.inline\"><mat-icon>search</mat-icon> {{ filterItem.label }}</mat-placeholder> </mat-form-field> </div> <div class=\"interface\" *ngIf=\"filterItem.type == 'select' && filterItem.values?.length > 0\"> <mat-form-field *ngIf=\"filterItem.multiple && !filterItem.groups\"> <mat-select [(ngModel)]=\"filterItem.model\" multiple=\"filterItem.multiple\" (onClose)=\"selectChange(filterItem)\" (keyup)=\"filterKeyup(filterItem,$event)\"> <mat-option *ngFor=\"let item of filterItem.values\" [value]=\"item.value\" [ngStyle]=\"item.style\"> {{ item.name }} </mat-option> </mat-select> <mat-placeholder *ngIf=\"filter.fsConfig.inline\">{{ filterItem.label }}</mat-placeholder> </mat-form-field> <mat-form-field *ngIf=\"!filterItem.multiple && !filterItem.groups\"> <mat-select [(ngModel)]=\"filterItem.model\" (change)=\"selectChange(filterItem)\" (keyup)=\"filterKeyup(filterItem,$event)\"> <mat-option *ngFor=\"let item of filterItem.values\" [value]=\"item.value\" [ngStyle]=\"item.style\"> {{ item.name }} </mat-option> </mat-select> <mat-placeholder *ngIf=\"filter.fsConfig.inline\">{{ filterItem.label }}</mat-placeholder> </mat-form-field> <!--<mat-form-field class=\"md-no-float md-no-label md-no-message\" ng-show=\"!filter.multiple && filter.groups\"> <mat-select ng-model=\"filter.model\" aria-label=\"select\" ng-change=\"selectChange(filter)\" ng-keyup=\"filterKeyup(filter,$event)\"> <md-optgroup label=\"{{group}}\" ng-repeat=\"(group, values) in filter.groups\"> <md-option ng-repeat=\"item in values\" value=\"{{::item.value}}\" ng-style=\"item.style\"> {{::item.name}} </md-option> </md-optgroup> </mat-select> </mat-form-field>--> <!--<md-input-container class=\"md-no-float md-no-label md-no-message\" ng-show=\"filter.multiple && filter.groups\"> <md-select ng-model=\"filter.model\" aria-label=\"select\" multiple=\"filter.multiple\" md-on-close=\"selectChange(filter)\" ng-keyup=\"filterKeyup(filter,$event)\"> <md-optgroup label=\"{{group}}\" ng-repeat=\"(group, values) in filter.groups\"> <md-option ng-repeat=\"item in values\" value=\"{{::item.value}}\" ng-style=\"item.style\"> {{::item.name}} </md-option> </md-optgroup> </md-select> </md-input-container>--> </div> <div class=\"interface interface-range\" *ngIf=\"filterItem.type == 'range'\" > <span fxLayout=\"row\"> <div> <mat-form-field class=\"filter-range-min\"> <input matInput [(ngModel)]=\"filterItem.model.min\" (change)=\"onFilterChange(filterItem)\" placeholder=\"{{ filterItem.placeholder[0] }}\"> </mat-form-field> </div> <div> <mat-form-field class=\"filter-range-max\"> <input matInput [(ngModel)]=\"filterItem.model.max\" (change)=\"onFilterChange(filterItem)\" placeholder=\"{{ filterItem.placeholder[1] }}\"> </mat-form-field> </div> </span> </div> <div class=\"interface\" *ngIf=\"filterItem.type == 'autocomplete'\"> <mat-form-field> <input matInput type=\"text\" [(ngModel)]=\"filterItem.model\" (ngModelChange)=\"onAutocompleteChange(filterItem)\"  name=\"{{ filterItem.name }}\" [matAutocomplete]=\"autocompleteInput\"> <mat-autocomplete #autocompleteInput=\"matAutocomplete\" [displayWith]=\"displayAutocomplete\"> <mat-option *ngFor=\"let item of filterItem.values$ | async\" [value]=\"item\">{{ item.name }}</mat-option> </mat-autocomplete> <mat-placeholder *ngIf=\"filter.fsConfig.inline\">{{ filterItem.label }}</mat-placeholder> </mat-form-field> </div> <div class=\"interface interface-date\" *ngIf=\"filterItem.type == 'date'\"> <mat-form-field> <input matInput fsDatepicker [(ngModel)]=\"filterItem.model\" readonly (change)=\"onFilterChange(filterItem)\" name=\"{{ filterItem.name }}\"> <mat-placeholder *ngIf=\"filter.fsConfig.inline\">{{ filterItem.label }}</mat-placeholder> </mat-form-field> </div> <div class=\"interface\" *ngIf=\"filterItem.type == 'autocompletechips'\"> <mat-form-field> <mat-chip-list #chipList> <mat-chip *ngFor=\"let item of filterItem.model\" (remove)=\"removeAutucompleteChipItem(filterItem, item)\"> {{ item.name }}<mat-icon matChipRemove>cancel</mat-icon> </mat-chip> <input #chipsInput matInput [(ngModel)]=\"filterItem.selectedValue\" (ngModelChange)=\"onAutocompleteChipsChange(filterItem, chipsInput)\" type=\"text\" name=\"{{ filterItem.name }}\" [matChipInputFor]=\"chipList\" [matAutocomplete]=\"autocompleteChipsInput\"> </mat-chip-list> <mat-autocomplete #autocompleteChipsInput=\"matAutocomplete\" [displayWith]=\"displayAutocomplete\" (optionSelected)=\"addAutucompleteChipItem(filterItem, $event)\"> <mat-option *ngFor=\"let item of filterItem.values$ | async\" [value]=\"item\">{{ item.name }}</mat-option> </mat-autocomplete> <mat-placeholder *ngIf=\"filter.fsConfig.inline\">{{ filterItem.label }}</mat-placeholder> </mat-form-field> </div> <div class=\"interface interface-checkbox\" *ngIf=\"filterItem.type == 'checkbox'\"> <mat-checkbox (change)=\"onFilterChange(filterItem)\" [(ngModel)]=\"filterItem.model\">{{ filter.fsConfig.inline ? filterItem.label : '' }}</mat-checkbox> </div> <!-- <div class=\"interface\" ng-if=\"filter.type == 'autocompletechips'\"> <md-chips-autocomplete-container class=\"md-block\"> <md-chips 	ng-model=\"filter.model\" md-autocomplete-snap md-require-match=\"false\" md-on-remove=\"filterChange(filter)\" md-on-add=\"filterChange(filter)\"> <md-autocomplete md-no-cache=\"true\" md-items=\"item in filter.values(filter.search, filter)\" md-search-text=\"filter.search\" md-item-text=\"\" md-min-length=\"1\" md-require-match md-autoselect> <span md-highlight-text=\"filter.search\">{{item.name}}</span> </md-autocomplete> <md-chip-template> <span> {{$chip.name}} </span> </md-chip-template> </md-chips> </md-chips-autocomplete-container> </div> <div class=\"interface  interface-datetime\" ng-if=\"filter.type == 'datetime'\"> <fs-datetime fs-class=\"md-no-label md-no-message\" fs-time=\"true\" fs-model=\"filter.model\" fs-change=\"filterChange(filter)\"></fs-datetime> </div> <div class=\"interface interface-daterange\" ng-if=\"filter.type == 'daterange'\"> <fs-datetime-range fs-class=\"md-no-label md-no-message\" fs-from=\"filter.model['from']\" fs-to=\"filter.model['to']\" fs-change=\"filterChange(filter)\"></fs-datetime-range> </div> <div class=\"interface interface-datetimerange\" ng-if=\"filter.type == 'datetimerange'\"> <fs-datetime-range fs-class=\"md-no-label md-no-message\" fs-from=\"filter.model['from']\" fs-to=\"filter.model['to']\" fs-change=\"filterChange(filter)\" fs-time=\"true\"></fs-datetime-range> </div> </div> --> </div> <div *ngIf=\"filterItem.isolate && !filter.fsConfig.inline\" class=\"filter isolate\"> <div class=\"filter-label\">{{ filterItem.isolate.label }}</div> <div class=\"interface\"> <mat-checkbox (change)=\"isolateChange(filterItem)\" [(ngModel)]=\"filterItem.isolate.enabled\"></mat-checkbox> </div> </div> </div> </ng-template> ",
                    styles: [".fs-filter { position: relative; margin-bottom: 20px; } .fs-filter .inline-filter { display: inline-block; } .fs-filter .inline-filter .filter-group { display: inline-block; } .fs-filter .title { display: none; } .fs-filter .results { min-height: 90px; position: relative; overflow-x: auto; overflow-y: hidden; } .fs-filter .status { position: relative; } .fs-filter .status .progress-infinite { position: absolute; top: 0; width: 100%; } .fs-filter .full-search .filter.filter-date > span { display: inline-block; } .fs-filter .filter-by { display: none; } .fs-filter .menu-filter .search { top: 8px; position: absolute; margin-left: 1px; left: 0; } .fs-filter .menu-filter .search mat-icon { transform: scale(0.9); } .fs-filter .menu-filter .backdrop { position: fixed; top: 0; bottom: 0; left: 0; right: 0; z-index: 69; outline: none; } .fs-filter .menu-filter .menu-filter-input { position: relative; /* .action-filter { display: none; z-index: 30; } */ /* TODO md-datepicker-container { width: 100%; .md-datepicker-input-container { margin-left: 0; } } */ } .fs-filter .menu-filter .menu-filter-input .inline-actions { white-space: nowrap; position: absolute; right: 0; top: 8px; z-index: 50; } .fs-filter .menu-filter .menu-filter-input .inline-actions a { color: rgba(0, 0, 0, 0.54); background: #fff; height: 22px; margin-bottom: 5px; } .fs-filter .menu-filter .menu-filter-input .inline-actions a i { transform: scale(0.9); vertical-align: middle; } .fs-filter .menu-filter .menu-filter-input .inline-actions a:hover { color: inherit; } .fs-filter .menu-filter .menu-filter-input mat-form-field { width: 100%; } .fs-filter .menu-filter .menu-filter-input .main-filter-bar { height: 40px; /* Largest height between inputs, buttons, icons */ } .fs-filter .menu-filter .menu-filter-input .main-filter-bar mat-form-field { width: 100%; /* input { padding-right: 26px; padding-left: 26px; position: relative; } */ } .fs-filter .menu-filter .menu-filter-input .filters { position: absolute; width: 100%; margin-top: -4px; display: none; } .fs-filter .menu-filter .menu-filter-input .filters .wrap { padding: 8px 17px 17px 17px; background: #fff; box-shadow: 0px 2px 4px -1px rgba(0, 0, 0, 0.2), 0px 4px 5px 0px rgba(0, 0, 0, 0.14), 0px 1px 10px 0px rgba(0, 0, 0, 0.12); overflow: auto; } .fs-filter .menu-filter .menu-filter-input .filters .filter-group { display: table-row-group; } .fs-filter .menu-filter .menu-filter-input .filters .filter { display: table-row; } .fs-filter .menu-filter .menu-filter-input .filters .filter .interface.interface-range input { text-align: center; } .fs-filter .menu-filter .menu-filter-input .filters .filter .interface.interface-datetime fs-datetime.has-time .md-input { width: 100%; } .fs-filter .menu-filter .menu-filter-input .filters .filter .interface fs-datetime-range input { text-align: center; } .fs-filter .menu-filter .menu-filter-input .filters .filter .interface, .fs-filter .menu-filter .menu-filter-input .filters .filter .filter-label { display: table-cell; } .fs-filter .menu-filter .menu-filter-input .filters .filter .filter-label { width: 1%; white-space: nowrap; vertical-align: middle; padding-right: 15px; } .fs-filter .menu-filter .menu-filter-input .filters md-autocomplete-container md-input-container { margin: 0; } .fs-filter .menu-filter .menu-filter-input .filters .isolate .interface { line-height: 20px; padding-top: 5px; } .fs-filter .menu-filter .menu-filter-input .filters .isolate md-checkbox { margin: 0 0 0 2px; } .fs-filter .menu-filter .menu-filter-input .filters .buttons { padding-top: 15px; } .fs-filter .menu-filter .menu-filter-input .filters .buttons .filter-button, .fs-filter .menu-filter .menu-filter-input .filters .buttons .reset-button { margin: 0; } .fs-filter .menu-filter .menu-filter-input .filters .buttons .reset-button { margin-left: 8px; } .fs-filter .filter { margin-right: 15px; display: inline-block; } .fs-filter .filter label { white-space: nowrap; color: rgba(0, 0, 0, 0.54); } .fs-filter .filter.filter-range mat-form-field { min-width: initial; width: 50px; } .fs-filter .filter.filter-range mat-form-field.filter-range-min { margin-right: 5px; } .fs-filter .infinite-records { color: #999; font-size: 13px; margin-left: 4px; white-space: nowrap; overflow: hidden; text-overflow: ellipsis; display: block; } .fs-filter .infinite-records .order-toggle { cursor: pointer; padding-left: 4px; } .fs-filter .infinite-records .saved-filters { float: right; display: flex; } .fs-filter .md-datepicker-calendar-pane { margin-left: -10px; } .fs-filter .saved-filter-menu { padding-top: 0; } .fs-filter .saved-filter-menu .my-saved-filters { line-height: 50px; padding: 0 10px; font-weight: bold; } .fs-filter.filters-open .inline-actions { z-index: 71; } .fs-filter.filters-open .main-filter-bar md-input-container input, .fs-filter.filters-open .menu-filter-input .filters { z-index: 70; display: block; } @media screen and (max-width: 750px) { .fs-filter .saved-filters { float: none; } } @media screen and (max-width: 599px) { body.fs-filters-open { overflow: hidden !important; } body.fs-filters-open .inline-actions { display: none; } .fs-filter { margin-top: 0; } .fs-filter .title { display: block; /* fs-heading { margin: 0; white-space: nowrap; overflow: hidden; text-overflow: ellipsis; } */ } .responsive-top-actions { display: block; } .filter-by { margin: 10px 0; } .menu-filter .menu-filter-input .filters .wrap { position: fixed; top: 0; left: 0; bottom: 0; right: 0; overflow-y: auto; z-index: 999; } .menu-filter .menu-filter-input .filters .filter-group, .menu-filter .menu-filter-input .filters .filter, .menu-filter .menu-filter-input .filters .filter .filter-label, .menu-filter .menu-filter-input .filters .filter .interface { display: block; } .menu-filter .menu-filter-input .action-reload { display: none; } .menu-filter .menu-filter-input .filter-group { margin: 10px 0 0 0; } .menu-filter .menu-filter-input .filter-group:first-child { margin: 0; } .menu-filter .menu-filter-input .filter .filter-label { line-height: 21px; display: block; -webkit-transform: translate3d(0, 7px, 0) scale(0.75); transform: translate3d(0, 7px, 0) scale(0.75); transition: cubic-bezier(0.25, 0.8, 0.25, 1) 0.25s; -webkit-transform-origin: left top; transform-origin: left top; color: rgba(0, 0, 0, 0.54); } } "],
                    encapsulation: core.ViewEncapsulation.None
                },] },
    ];
    /** @nocollapse */
    FsFilterComponent.ctorParameters = function () { return [
        { type: common$1.FsUtil, },
        { type: common$1.FsArray, },
        { type: store.FsStore, },
        { type: router.Router, },
        { type: router.ActivatedRoute, },
    ]; };
    FsFilterComponent.propDecorators = {
...
var FsFilterModule = (function () {
    ...
    FsFilterModule.decorators = [
        { type: core.NgModule, args: [{
                    ...
                    providers: [
                        FsFilter,
                        { provide: material.MAT_PLACEHOLDER_GLOBAL_OPTIONS, useValue: ɵ0 }
                    ],
                    exports: [
                        FsFilterComponent
                    ]
    ...
    /** @nocollapse */
    FsFilterModule.ctorParameters = function () { return []; };
    return FsFilterModule;
}());

exports.FilterConfigItem = FilterConfigItem;
